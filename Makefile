...
# Install/Uninstall make script for paranoid-linux/build-firejail-chroot
...
#
SCRIPT_NAME := build-firejail-chroot
...
completion: ## Builds tab completion Bash configuration file for build-firejail-chroot
	"help-to-complete" --executable "$(ROOT_DIRECTORY_PATH)/build-firejail-chroot" --completion-dir "$(ROOT_DIRECTORY_PATH)/bash-completion" --clobber

link-completion: SHELL := /bin/bash
link-completion: ## Links tab completion  Bash configuration file for build-firejail-chroot
